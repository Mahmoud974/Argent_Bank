  ...
  return (
    <ul className="flex flex-wrap lg:flex-row space-y-12 lg:space-y-0 lg:items-start lg:mt-0 items-center mt-96 flex-col container mx-auto justify-around pt-12 pb-6">
      <li className="text-center">
        <figure className="border-[#02BC77] rounded-full border-8 w-28 h-28 flex items-center justify-center mx-auto">
          <img src={icon_chat} alt="Chat icon" />
        </figure>
        <h3 className="font-bold my-4">You are our #1 priority</h3>
        <p className="text-[#3C4B5C] lg:w-96 w-80 text-sm">
      ...
      <li className="text-center">
        ...
        <h3 className="font-bold my-4">More savings means higher rates</h3>
        <p className="text-[#3C4B5C] lg:w-96 w-80 text-sm">
      ...
      <li className="text-center">
        ...
        <h3 className="font-bold my-4">Security you can trust</h3>
        <p className="text-[#3C4B5C] lg:w-96 w-80 text-sm">
